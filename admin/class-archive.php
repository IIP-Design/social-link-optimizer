...
class Archive {
   ...
   *
   * @deprecated Removed since mission page is autogenerated, to re-instate, hook into the 'init' action.
   *
   * @since 0.0.1
   */
   ...
   *
   * @deprecated Removed since mission page is autogenerated, to re-instate, hook into the 'admin_enqueue_scripts' action.
   *
   * @since 0.0.1
   */
   ...
   *
   * @deprecated Removed since mission page is autogenerated, to re-instate, hook into the 'add_meta_boxes' action.
   *
   * @since 0.0.1
   */
  ...
  public function add_mission_select( $post ) {
    // Initialize the custom post type class in order to .
   ...
   *
   * @deprecated Removed since mission page is autogenerated, to re-instate, hook into the 'save_post' action.
   *
   * @since 0.0.1
   */
